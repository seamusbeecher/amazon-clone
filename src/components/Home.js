...
function Home(props) {
    ...
    //Set up using an array in an attempt to try and implement a filter for the search bar in Header.js
    ...
    return (
        <div className='home'>
            ...
            <div className='home'>
                {products.map((item) => (
                    <h1>{item.props.price}</h1>
                ))}
            </div>
            <div className='home'>
                {products.map((item) => (
                    <h1>{item.props.image}</h1>
                ))}
            </div>
            <div className='home'>
                {products.map((item) => (
                    <h1>{item.props.rating}</h1>
                ))}
            </div> */}
